...
public String[] getLinkNamesForJoint(String aName)
{
    switch(aName) {
        ...
        case HeadTop_Joint: return new String[] { Head };
        ...
        case RHandEnd_Joint: return new String[] { RHand };
        ...
        case RFootEnd_Joint: return new String[] { RFoot };
        ...
        case LHandEnd_Joint: return new String[] { LHand };
        ...
        case LFootEnd_Joint: return new String[] { LFoot };
