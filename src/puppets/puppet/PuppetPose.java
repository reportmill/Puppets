...
private static double getAngle(Point p0, Point p1)  { return getAngle(p0.x, p0.y, p1.x, p1.y); }

/** Returns the angle for a set of line point coordinates. */
private static double getAngle(double x0, double y0, double x1, double y1)  { return Math.atan2(y1 - y0, x1 - x0); }
